...
\item Allgemein
	\begin{itemize}
		...
		\item Die Ajax-Response soll ein einfaches Uploads-Array zurück senden, das beim Submit des Formulars an den jeweiligen Controler übergeben wird.
		\item Es soll ein Viewhelper zur Verfügung gestellt werden, der eine Konfiguration lädt und die nötigen HTML-Elemente für das Frontend erzeugt.
	\end{itemize}
\item Backend und Konfiguration
	\begin{itemize}
		\item Die Konfiguration soll in der ext\_localconf.php der Extension erfolgen.
		\item Es sollen mehrere Konfigurationen vorgenommen werden können.
		\item Folgende Optionen sollen standardmäßig zur Verfügung gestellt werden:
			\begin{itemize}
				...
				\item TTL
			\end{itemize}
		\item Darüber hinaus sollen zur Erweiterung eigene Optionen definiert werden können. 
	\end{itemize}
\end{itemize}